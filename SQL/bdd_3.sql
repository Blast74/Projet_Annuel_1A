...
INSERT INTO `users`     ( `email`, `pseudo`, `image`, `gender`, `firstname`, `lastname`, `birthday`, `register_date`, `country`, `pwd`, `moderator`, `access_token`, `update_date`, `active_account`) VALUES
                        ('root@musiquereview.com', 'SuperUser', NULL, 'm', 'root', 'root', '1991-03-01', '1991-03-01', 'fr', '$2y$10$pVPoizfLjqBUFAwlhJCSmebwSZBHF2sZKv2ctB2w7K1JWOLakggNe', 3, NULL, NULL, 1),
                        ('moderateur@musiquereview.fr', 'moderateur', NULL, 'm', 'moderateur', 'mod', '1994-12-11', '1994-12-11', 'fr', '$2y$10$cmgfyXfUme3/RpFtxmLktuP/N.3ASk8ULDOC3hAifew/x7q8mAUxy', 2, NULL, NULL, 1),
                        ...
                        ('terence74@gmail.com', 'Terence75012', NULL, 'm', 'Terence', 'Venzo', '1994-06-30', '1994-06-30', 'fr', '$2y$10$uSkCzaJTfvTIDnLy.aEHlO3M4Zr7dZKgOZ1DE3itcKBOwGREgGgdi', 1, NULL, NULL, 1),
                        ('antoine@gmail.fr', 'antoine3000', NULL, 'm', 'Antoine', 'Esquirol', '1994-09-08', '1994-09-08', 'fr', '$2y$10$cNdhV7gCy.49llC/qVLis.AEZofYBzODguMgWKx9Y6lxt0y6fzm72', 1, NULL, NULL, 1),
